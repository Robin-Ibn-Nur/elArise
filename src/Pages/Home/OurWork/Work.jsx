        ...
        <>
            ...
            <div className="container mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-10 place-items-center my-10">
                {details.map((detail, index) => (
                    <div key={index} className="border border-green-200 hover:border-green-500 cursor-pointer transition ease-in-out delay-150 duration-300 p-4 w-64 bg-gray-200 text-center shadow">
                        {detail}
                    </div>
                ))}
            </div>
