                ...
                <div className="flex flex-wrap justify-center items-center space-x-2 sm:space-x-0 lg:space-x-8 my-10">
                    {backers.map((backer, index) => (
                        <div key={index} className="flex-shrink-0 mb-4 sm:mb-4 lg:mb-0">
                            <div className="border border-green-200 hover:border-green-500 cursor-pointer transition ease-in-out delay-150 duration-300 p-4 sm:w-full md:w-1/2 lg:w-64 bg-gray-200 text-center shadow">
                                {backer}
                            </div>
                        </div>
                    ))}
